...
const NavBar: React.FC<NavBarProps> = ({ darkMode, toggleDarkMode, isAtTop }) => {
    ...
    const lightColors = {
        navBg: 'bg-linear-br from-orange-200 to-white',
    ...
    const darkColors = {
        navBg: 'bg-linear-br from-gray-700 to-black',
    ...
    return (
        <div className={`flex justify-center w-full fixed z-50 transition-all duration-700 ease-in-out ${isAtTop ? 'top-4' : 'bottom-4'}`}>
            <motion.nav
                ...
                <div className="flex items-center justify-between w-full space-x-6 lg:space-x-8">
                    ...
                    >
                        <span className={`text-xl font-bold ${colors.textPrimary}`}>
                            Kevin<span className="text-orange-500">.</span>
                        </span>
                    </motion.a>
